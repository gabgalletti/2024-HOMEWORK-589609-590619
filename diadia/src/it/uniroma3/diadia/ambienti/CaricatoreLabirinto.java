...
public class CaricatoreLabirinto {	
		...
		for(String specifica : separaStringheAlleVirgole(specificheStanze)) {
			...
			try (Scanner scannerDiLinea = new Scanner(specifica)) 	{	
				while (scannerDiLinea.hasNext()) {
					...
					this.nomeStanza.get(nomeStanza).setPersonaggio(personaggio);
				}
			}
		} 
	}
	...
	private void leggiInizialeEvincente() throws FormatoFileNonValidoException {
		...
		this.stanzaIniziale = this.nomeStanza.get(nomeStanzaIniziale);
		this.stanzaVincente = this.nomeStanza.get(nomeStanzaVincente);
	}
	...
	private void posaAttrezzo(String nomeAttrezzo, String pesoAttrezzo, String nomeStanza) throws FormatoFileNonValidoException {
		...
		try {
			...
			this.nomeStanza.get(nomeStanza).addAttrezzo(attrezzo);
		}
	...
	private boolean isStanzaValida(String nomeStanza) {
		return this.nomeStanza.containsKey(nomeStanza);
	}
	...
	private void impostaUscita(String stanzaDa, String dir, String nomeA) throws FormatoFileNonValidoException {
		...
		Stanza partenzaDa = this.nomeStanza.get(stanzaDa);
		Stanza arrivoA = this.nomeStanza.get(nomeA);
